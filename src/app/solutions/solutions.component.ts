...
export class SolutionsComponent {
  ...
  insightsData = ['Access high-quality African data across diverse sectors, readily available through APIs or convenient CSV downloads. Interact with our powerful data sets and quickly visualize insights to power your decision-making. Custom analyses and sector reports.', './assets/images/data-publishingb.svg'];
